...
import com.lingobot.auth.dto.UpdateAvatarRequest;
import com.lingobot.auth.dto.UpdateUsernameRequest;
import com.lingobot.auth.dto.UserDTO;
import com.lingobot.auth.service.AuthService;
import com.lingobot.auth.service.EmailVerificationService;
import com.lingobot.common.response.ApiResponse;
import com.lingobot.util.IpUtils;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<Void>> logout() {
        authService.logout();
        return ResponseEntity.ok(ApiResponse.success("退出登录成�?, null));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> sendVerificationCode(@RequestBody SendVerificationCodeRequest request) {
        ...
        return ResponseEntity.ok(ApiResponse.success("验证码已发�?, null));
    }
