...
import com.lingobot.learning.vocabulary.generation.service.MeaningCheckService;
import com.lingobot.learning.vocabulary.generation.service.SentenceAnalysisService;
import com.lingobot.learning.vocabulary.graph.VocabularyBatchGraph;
...
public class VocabularyCardServiceImpl implements VocabularyCardService {
    ...
    public VocabularyCardDTO getNextCard(Long conversationId, Integer currentPosition, String category, String difficulty) {
        ...
        if (cardDTOs.isEmpty()) {
            ...
            throw ChatException.badRequest("批量生成词汇卡失败");
        }
    ...
    public VocabularyCardDTO regenerateCardAtPosition(Long conversationId, Integer position, String category, String difficulty) {
        ...
        if (existingCardOpt.isEmpty()) {
            log.warn("该位置没有有效词汇卡: position={}", position);
            throw ChatException.badRequest("该位置没有有效词汇卡");
        }
